...
<head>
    ...
    <style>
   *,::after,::before,header nav.navbar .navbar-brand{padding:0;margin:0}*,::after,::before{box-sizing:border-box}@media (prefers-reduced-motion:no-preference){:root{scroll-behavior:smooth}}@font-face{font-family:"Poppins Fallback";src:local("Segoe UI");size-adjust:111.20%;ascent-override:97.80%;descent-override:31.40%;line-gap-override:0%}:root{--bg:#f4f6fb;--bg-2:#eaeef5;--card:#ffffff;--card-2:#f6f8fc;--text:#0f172a;--muted:#64748b;--accent:#c6f24e;--accent-dark:#a9d630;--accent-soft:rgba(170, 214, 48, .08);--accent-ring:rgba(170, 214, 48, 0.18);--border:#e2e8f0;--border-active:#c6f24e;--radius:16px;--radius-sm:12px;--shadow:0 20px 50px rgba(170, 214, 48, .08);--transition:.25s cubic-bezier(.4, 0, .2, 1)}body{font-family:Poppins,"Poppins Fallback",Arial,Helvetica,sans-serif!important}.logo-one img,.logo-two img{object-fit:contain}.logo-two,.review-line{display:flex;flex-direction:row;flex-wrap:wrap}header{background:#fff;width:100%;box-shadow:0 0 20px -5px #b2b2b2;position:fixed;top:0;z-index:1000;transition:.3s ease-in-out}header nav.navbar{padding:10px 0;align-items:center;position:inherit}header nav.navbar .navbar-brand .logo{max-width:100%;height:45px;object-fit:contain;margin:0;transition:.5s ease-in-out;display:block}header nav.navbar .website-main-buttons{justify-content:center;margin:0;gap:10px}header nav.navbar .website-main-buttons a.call-btn{background:0 0;color:#161a1d;border:2px solid #8340ee;border-radius:5px;margin:0}.banner-main-content .website-main-buttons button.chat-btn:hover{background:#8340ee;color:#fff;transform:scale(.9);border-color:#8340ee}header nav.navbar .website-main-buttons a.call-btn i{margin:0 0 0 5px;transform:rotate(-45deg)}.banner-main-sec{min-height:400px;padding:160px 0 50px;position:relative;z-index:1;background:#000;overscroll-behavior-y:contain}.banner-main-sec .bg-img{position:absolute;top:0;left:0;right:0;bottom:0;z-index:-1}.banner-main-sec .bg-img .banner-img{object-fit:cover;object-position:center;height:100%;width:100%}.banner-main-content .heading-one{font-size:30px;font-weight:700;line-height:40px;color:#fff;margin:0 0 19px;text-align:left}.banner-main-content p{color:#fff;text-align:left}.banner-main-content .website-main-buttons{margin:30px 0 0;gap:10px}.banner-main-content .website-main-buttons button.chat-btn{background:0 0;color:#fff;border:2px solid #8340ee;border-radius:5px}.banner-bulid-points{margin-bottom:15px}.logo-one,.logo-two{display:flex;flex-wrap:wrap;flex-direction:row;gap:15px;margin:0 0 20px}.banner-bulid-points ul li{color:#fff;list-style:none;position:relative;padding:0 0 0 30px}.banner-bulid-points ul li::before{content:var(--icon);font-family:"Font Awesome 7 Free";font-weight:700;color:var(--accent);position:absolute;left:0}.logo-two img{height:50px}.review-line span{margin:0 10px;list-style:none}.banner-inner-published-form{width:100%;background:var(--card);border:1px solid var(--border);border-radius:var(--radius);padding:28px 26px 22px;box-shadow:var(--shadow)}.form-header{text-align:center;margin-bottom:18px}.form-header h3{font-size:22px;font-weight:800;letter-spacing:.3px;margin:0 0 6px;text-transform:uppercase;color:var(--text)}.form-header p{font-size:14px;color:var(--muted);margin:0}.form-header p span{color:#00e533;font-weight:700;font-size:20px;text-decoration:underline}.progress-wrap{margin-bottom:22px}.progress-track{height:8px;background:var(--card-2);border-radius:999px;overflow:hidden;border:1px solid var(--border)}.progress-fill{height:100%;width:0%;background:linear-gradient(90deg,var(--accent-dark),var(--accent));border-radius:999px;transition:width .45s cubic-bezier(.4, 0, .2, 1);box-shadow:0 0 12px var(--accent-ring)}.btn-nav,.card-inner,.card-inner i,.field-input{transition:all var(--transition)}.progress-meta{display:-webkit-box;display:-webkit-flex;display:flex;justify-content:space-between;margin-top:8px;font-size:12px;color:var(--muted);font-weight:500}.form-step{animation:.35s fadeSlide}@keyframes fadeSlide{from{opacity:0;transform:translateY(8px)}to{opacity:1;transform:translateY(0)}}.question-block{margin-bottom:20px}.question-title{font-size:14px;font-weight:600;margin:0 0 10px;color:var(--text);display:flex;align-items:center;gap:6px}.q-num{color:var(--muted);font-weight:700}.card-inner,.step-heading{color:var(--text);text-align:center}.step-heading{font-size:16px;font-weight:700;margin:0 0 16px}.radio-card-group{margin:0;display:grid;grid-template-columns:repeat(auto-fill,minmax(100px,1fr));gap:10px}.radio-card{display:block;cursor:pointer;margin:0;height:100%}.radio-card input{position:absolute;opacity:0;pointer-events:none}.card-inner{display:flex;align-items:center;justify-content:center;flex-direction:column;gap:8px;padding:14px 10px;background:var(--card-2);border:1.5px solid var(--border);border-radius:var(--radius-sm);font-size:13px;font-weight:500;height:100%;min-height:56px;position:relative}.card-inner i,.field-label,.radio-card input:checked+.card-inner i{color:var(--muted)}.btn-nav,.card-inner i,.field-input{font-size:14px}.radio-card:hover .card-inner{border-color:var(--accent);transform:translateY(-2px);background:#fff;box-shadow:0 6px 16px rgba(198,242,78,.08)}.radio-card:hover .card-inner i{color:var(--accent)}.radio-card input:checked+.card-inner{border-color:var(--accent);background:var(--accent-soft);box-shadow:0 0 0 3px var(--accent-ring)}.radio-card input:checked+.card-inner::after{content:"\f00c";font-family:"Font Awesome 7 Free";font-weight:900;position:absolute;top:6px;right:8px;font-size:10px;color:var(--muted)}.field-input.is-invalid,.radio-card-group.error .card-inner{border-color:#ef4444;animation:.3s shake}@keyframes shake{0%,100%{transform:translateX(0)}25%{transform:translateX(-4px)}75%{transform:translateX(4px)}}.field-label{font-size:12px;font-weight:600;margin-bottom:6px;text-transform:uppercase;letter-spacing:.5px}.btn-prev,.field-input{background:#fff;color:var(--text)}.field-input{border:1.5px solid var(--border);border-radius:var(--radius-sm);padding:12px 14px;width:100%}.field-input::placeholder{color:#94a3b8;font-size:14px}.field-input:focus{outline:0;border-color:var(--accent)!important;background:#fff;box-shadow:0 0 0 3px var(--accent-ring)!important}textarea.field-input{resize:vertical}.form-nav{display:flex;gap:10px;margin-top:18px}.btn-nav{flex:1;padding:14px 18px;border-radius:var(--radius-sm);font-weight:700;border:none;cursor:pointer;display:inline-flex;align-items:center;justify-content:center;gap:8px;letter-spacing:.3px}.btn-prev{border:1.5px solid var(--border);flex:0 0 auto;padding:14px 20px}.btn-prev:hover{background:var(--card-2);border-color:#cbd5e1}.btn-next,.btn-submit{background:var(--accent-dark);color:#fff;text-transform:uppercase;box-shadow:0 8px 20px rgba(198,242,78,.25)}.btn-next:hover,.btn-submit:hover{transform:translateY(-2px);box-shadow:0 12px 28px rgba(198,242,78,.35)}.btn-next:active,.btn-submit:active{transform:translateY(0)}.trust-note{margin:14px 0 0;font-size:12px;text-align:center;color:var(--muted)}@media (max-width:480px){.banner-inner-published-form{padding:22px 18px 18px}.form-header h3{font-size:18px}.card-inner{font-size:12px;padding:12px 8px;min-height:50px}.btn-nav{font-size:13px;padding:12px 14px}}[hidden]{display:none!important}.whatsapp-float{position:fixed;bottom:15px;left:15px;right:auto;height:50px;width:50px;align-content:center;text-align:center;background-color:#25d366;border-radius:50%;padding:5px;z-index:9999;box-shadow:0 2px 10px rgba(0,0,0,.3);transition:transform .2s ease-in-out}.whatsapp-float:hover{transform:scale(1.1)}.whatsapp-float>i{color:#fff;font-size:26px}
    </style>
...
!function(e,t,a,r,g){e[r]=e[r]||[],e[r].push({"gtm.start":new Date().getTime(),event:"gtm.js"});var n=t.getElementsByTagName(a)[0],s=t.createElement(a);s.async=!0,s.src="https://www.googletagmanager.com/gtm.js?id="+g+("dataLayer"!=r?"&l="+r:""),n.parentNode.insertBefore(s,n)}(window,document,"script","dataLayer","GTM-K52MGDH2");
    ...
    <script id="vtag-ai-js" async src="https://r2.leadsy.ai/tag.js" data-pid="3YGHIQ0iUzhQ3nlP" data-version="062024"></script>
</head>

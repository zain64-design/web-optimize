...
<p class="text-center">Signup Now! and Get <span>35% OFF</span> Today!</p>
    <form action="https://leads.infinityprojectmanager.com/brand/goodspeedpublishing/lead" method="GET" class="myForm">
        ...
        <input type="hidden" id="lead_area" name="lead_area" value="https://goodspeedpublishing.com/lp/book-publishing">
        <div class="row">
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    <select name="manuscript-ready" class="form-select" aria-label="Default select example">
                        ...
                        <option value="Yes, I'll be ready to publish in 1 to 3 months">Yes, I'll be ready to publish in
                            1 to 3 months</option>
                        <option value="Yes, I'll be ready to publish in 3 to 6 months">Yes, I'll be ready to publish in
                            3 to 6 months</option>
                        <option value="Yes, I’ll be ready to publish in 6 to 12 months">Yes, I’ll be ready to publish in
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    <select name="published-before" class="form-select" aria-label="Default select example">
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
                    <select name="plan-on-publishing" class="form-select" aria-label="Default select example">
            ...
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div class="form-group">
            <textarea name="message" placeholder="Tell Us A Little Bit About Your Book" required=""></textarea>
        </div>
            </div>
            <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">

...
<head>
    ...
    <link rel="stylesheet" href="assets/css/custom-not.css" />
    ...
    <main>
        ...
        <section class="banner-main-sec">
            <picture class="bg-img">
                ...
                <img src="assets/images/banner-publishing-bg.jpg" class="banner-img" alt="Banner" loading="eager" fetchpriority="high">
            </picture>
            <div class="container">
                <div
                        ...
                        <div class="banner-inner-published-form" data-aos="fade-left" data-aos-duration="1500">
                            ...
                            <form action="https://leads.infinityprojectmanager.com/brand/goodspeedpublishing/lead"
                                ...
                                <div class="row">
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <select name="manuscript-ready" class="form-select"
                                                ...
                                                <option value="Yes, I'm ready to publish today">Yes, I'm ready to
                                                    publish
                                                    today</option>
                                                <option value="Yes, I'll be ready to publish in 1 to 3 months">Yes, I'll
                                                    be
                                                    ready to publish in
                                                    1 to 3 months</option>
                                                <option value="Yes, I'll be ready to publish in 3 to 6 months">Yes, I'll
                                                    be
                                                    ready to publish in
                                                    3 to 6 months</option>
                                                <option value="Yes, I’ll be ready to publish in 6 to 12 months">Yes,
                                                    I’ll be
                                                    ready to publish in
                                                    6 to 12 months</option>
                                                <option value="No, I do not have a book or manuscript ready">No, I do
                                                    not
                                                    have a book or
                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <select name="plan-on-publishing" class="form-select"
                                                aria-label="Default select example">
                                                <option selected disabled>What type of book do you plan on publishing?
                                                </option>
                                            ...
                                            <div class="dropdown ct-select" name="services">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="self-publishing" value="Self Publishing"
                                                                id="selfPublishing">
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="editing" value="Editing" id="editing">
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="cover-design" value="Cover Design"
                                                                id="coverDesign">
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="printing" value="Printing" id="printing">
                                                    ...
                                                    <li>
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox"
                                                                name="marketing" value="Marketing" id="marketing">
                                    ...
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <textarea name="message" placeholder="Tell Us A Little Bit About Your Book"
                                                required=""></textarea>
                                        </div>
                                    </div>
                                    <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">

...
<head>
    ...
    <link rel="preload" as="image" href="assets/images/banner-publishing-bg.webp" fetchpriority="high">
        <style>
.banner-inner-published-form .form-group .form-select,.banner-inner-published-form .form-group textarea{font-family:Poppins,sans-serif;background-color:#fbfbfb;outline:0;box-shadow:none;width:100%;font-size:16px}body{font-family:Poppins,sans-serif}header{background:#fff;width:100%;box-shadow:0 0 20px -5px #b2b2b2;position:fixed;top:0;z-index:1000;transition:.3s ease-in-out}header nav.navbar{padding:10px 0;align-items:center;position:inherit}header nav.navbar .navbar-brand{padding:0;margin:0}header nav.navbar .navbar-brand .logo{max-width:100%;height:45px;object-fit:contain;margin:0;transition:.5s ease-in-out;display:block}header nav.navbar .website-main-buttons{justify-content:center;margin:0;gap:10px}header nav.navbar .website-main-buttons a.call-btn{background:0 0;color:#161a1d;border:2px solid #8340ee;border-radius:5px;margin:0}.banner-main-content .website-main-buttons button.chat-btn:hover{background:#8340ee;color:#fff;transform:scale(.9);border-color:#8340ee}header nav.navbar .website-main-buttons a.call-btn i{margin:0 0 0 5px;transform:rotate(-45deg)}.banner-main-sec{padding:160px 0 50px;position:relative;z-index:1;background:#000}.banner-main-sec .bg-img{position:absolute;top:0;left:0;right:0;bottom:0;z-index:-1}.banner-main-sec .bg-img .banner-img{object-fit:cover;object-position:center;height:100%;width:100%}.banner-main-content .heading-one{color:#fff;margin:0 0 20px;text-align:left}.banner-main-content p{color:#fff;margin:0 0 10px;text-align:left}.banner-main-content .website-main-buttons{margin:30px 0 0;gap:10px}.banner-main-content .website-main-buttons button.chat-btn{background:0 0;color:#fff;border:2px solid #8340ee;border-radius:5px}.banner-inner-published-form{background:#fff;width:100%;border-radius:0;box-shadow:0 0 15px -5px #fff;padding:20px;margin:0 auto}.banner-inner-published-form .form-group{position:relative;padding:0 0 20px}.banner-inner-published-form .form-group textarea{padding:15px 10px 10px;color:#000;border:2px solid #e9e7e7;height:100px;border-radius:0;resize:none}.banner-inner-published-form .form-group button.submit-btn:hover{transform:scale(.9)}.banner-inner-published-form h4{color:#000;font-size:clamp(18px, 1.5vw, 26px);line-height:32px;margin:0 0 10px;text-transform:capitalize;font-weight:700;text-wrap-style:pretty}.banner-inner-published-form p{font-size:clamp(14px, 1.2vw, 16px);font-weight:500;text-align:left}.banner-inner-published-form p span{color:#00e533;font-weight:700;font-size:20px;text-decoration:underline}.banner-inner-published-form .form-group.form-group-last{margin:0}.banner-inner-published-form .form-group .form-select{font-weight:500;color:#000;border-radius:0;border:2px solid #e9e7e7;padding:10px 30px 10px 10px;cursor:pointer}.banner-inner-published-form .form-group input{background:#fbfbfb;color:#000;font-size:16px;width:100%;height:45px;border:2px solid #e9e7e7;border-radius:0;padding:10px 8px}.banner-inner-published-form .form-group input::placeholder{color:#b2b2b2;font-size:16px}.banner-inner-published-form .form-group button.submit-btn{background:linear-gradient(267.57deg,#c2f15e -3.55%,#c2f15e 100.02%);color:#000;border:none;font-size:18px;width:175px;height:45px;border-radius:5px;padding:8px 10px;margin:10px 0 0;display:flex;align-items:center;justify-content:center;transition:.3s ease-in-out}
    </style>
                ...
                <div class="row">
                    <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 col-sm-12 col-12">
                        <div class="step-works-head" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <p>We believe in total transparency. You’ll be involved at every stage with clear updates
                                and
                                approval checks, ensuring your finished book is exactly how you imagined it, or better.
                            </p>
                            ...
                            <div class="row">
                                    ...
                                    <div class="step-works-box" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                        ...
                                        <div class="works-box-head">
                                            ...
                                            <div class="work-box-head-img">
                                                <img loading="lazy"
                                                    src="assets/images/icons-imgs/content-review-white.webp"
                                                    alt="Content Review" class="img-fluid">
                                            </div>
                                        </div>
                                        <p>Send us your manuscript. Our team will review your draft and chat with you
                                            about
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="step-works-box" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                        ...
                                        <p>We carefully proofread and edit your work, refining the flow while making
                                            sure it
                                ...
                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="step-works-box" data-aos="flip-left" data-aos-easing="ease-out-cubic"
                                        ...
                                        <div class="works-box-head">
                                            ...
                                            <div class="work-box-head-img">
                                                <img loading="lazy" src="assets/images/icons-imgs/vector.webp"
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="cta-banner-content" data-aos="fade-right" data-aos-duration="1500">
                            ...
                            <p>Our talented team is ready to bring your story to life. We can get your book published
                                and
                        ...
                        <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="portfolio-publish-buttons">
                                <ul class="nav nav-pills" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link active" id="pills-portfolio1-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio1" type="button" role="tab"
                                            aria-controls="pills-portfolio1" aria-selected="true">Action</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio2-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio2" type="button" role="tab"
                                            aria-controls="pills-portfolio2" aria-selected="false">Comics</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio3-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio3" type="button" role="tab"
                                            aria-controls="pills-portfolio3" aria-selected="false">Fiction</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio4-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio4" type="button" role="tab"
                                            aria-controls="pills-portfolio4" aria-selected="false">Children's</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio5-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio5" type="button" role="tab"
                                            aria-controls="pills-portfolio5" aria-selected="false">Romance</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio6-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio6" type="button" role="tab"
                                            aria-controls="pills-portfolio6" aria-selected="false">Sci-Fi</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio7-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio7" type="button" role="tab"
                                            aria-controls="pills-portfolio7" aria-selected="false">Mystery</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio8-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio8" type="button" role="tab"
                                            aria-controls="pills-portfolio8" aria-selected="false">Thriller</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio9-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio9" type="button" role="tab"
                                            aria-controls="pills-portfolio9" aria-selected="false">Non-Fiction</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio10-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio10" type="button" role="tab"
                                            aria-controls="pills-portfolio10" aria-selected="false">Horror</button>
                                    </li>
                                    <li class="nav-item" role="presentation" data-aos="zoom-in" data-aos-offset="300"
                                        data-aos-easing="ease-in-sine">
                                        <button class="nav-link" id="pills-portfolio10-tab" data-bs-toggle="pill"
                                            data-bs-target="#pills-portfolio11" type="button" role="tab"
                                            aria-controls="pills-portfolio11" aria-selected="false">Adult Books</button>
                                    </li>
                                </ul>
                            </div>
                            <div class="portfolio-publish-tabitem">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-portfolio1" role="tabpanel"
                                        aria-labelledby="pills-portfolio1-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        data-aos-duration="1000">
                                                        <h4 class="heading-three">Action</h4>
                                                        <p>If your story involves high-speed chases, narrow escapes, and
                                                            things
                                                            blowing up in the background (while the hero doesn't look
                                                            back,
                                                            obviously), we’re your crew. We help you pack every page
                                                            with enough
                                                            adrenaline to make readers forget to breathe. Safety goggles
                                                            are not
                                                        ...
                                                        <div class="website-main-buttons">
                                                            ...
                                                            <button class="chat-btn"
                                                                onclick="<?php echo $locChatClick; ?>">Live
                                                                Chat!</button>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/action.webp"
                                                            alt="Action Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio2" role="tabpanel"
                                        aria-labelledby="pills-portfolio2-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>They say a picture is worth a thousand words, but we think
                                                            the right
                                                            "POW!" or "ZAP!" is priceless. Whether you’re building a
                                                            superhero
                                                            universe or a quirky indie memoir, we help you marry bold
                                                            art with sharp
                                                            dialogue. Let’s make some panels that actually pop off the
                                                            page.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/comics.webp"
                                                            alt="Comics Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio3" role="tabpanel"
                                        aria-labelledby="pills-portfolio3-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>Real life is fine, but made-up worlds are much better. If
                                                            you’re building a sprawling empire or just a messy
                                                            neighborhood drama, we’re here to help you lie
                                                            professionally. We’ll take your "what if" and turn it into a
                                                            "must-read" that keeps people up way past their bedtime.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                            <button class="chat-btn"
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/fiction.webp"
                                                            alt="Fiction Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio4" role="tabpanel"
                                        aria-labelledby="pills-portfolio4-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>Writing for kids is serious business mostly because they are
                                                            the toughest critics on the planet. Be it bedtime stories or
                                                            middle-grade adventures, we help you create characters that
                                                            kids love and parents don’t mind reading for the millionth
                                                            time. Let’s make some magic.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                            <button class="chat-btn"
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/children.webp"
                                                            alt="Childrens Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio5" role="tabpanel"
                                        aria-labelledby="pills-portfolio5-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>We’re suckers for a good "enemies-to-lovers" trope. We help
                                                            you capture that butterflies-in-the-stomach feeling. Your
                                                            readers are looking for a happily-ever-after, and we’re here
                                                            to make sure the sparks fly on every single page. Tissue
                                                            boxes sold separately. </p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                            <button class="chat-btn"
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/romance.webp"
                                                            alt="Romance Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio6" role="tabpanel"
                                        aria-labelledby="pills-portfolio6-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>Lasers, portals, and existential dread about AI? Count us in.
                                                            We help you build worlds that feel grounded even if they’re
                                                            lightyears away. Let’s take your "science" and add just
                                                            enough "fiction" to make it legendary.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                            <button class="chat-btn"
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/sci-fi.webp"
                                                            alt="Science Fiction Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio7" role="tabpanel"
                                        aria-labelledby="pills-portfolio7-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>We love a good puzzle as much as you do. We’ll help you
                                                            scatter the breadcrumbs, plant the red herrings, and hide
                                                            the truth in plain sight until that big, shocking reveal.
                                                        </p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/mystery.webp"
                                                            alt="Mystery Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio8" role="tabpanel"
                                        aria-labelledby="pills-portfolio8-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>If your manuscript is the literary equivalent of a heart
                                                            attack, you’re in the right place. We specialize in those
                                                            "just one more chapter" vibes that lead to sunrise. </p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                            <button class="chat-btn"
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/thriller.webp"
                                                            alt="Thriller Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio9" role="tabpanel"
                                        aria-labelledby="pills-portfolio9-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>Real life is weirder than fiction, and we’re here to help you
                                                            ...
                                                            actually engaging. Let’s make "learning stuff" feel like a
                                                            total blast.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/non-fiction.webp"
                                                            alt="Non-Fiction Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio10" role="tabpanel"
                                        aria-labelledby="pills-portfolio10-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>We want to help you give people nightmares. Seriously. If
                                                            your story features creepy basements, psychological twists,
                                                            or things that go bump in the night, we’re ready to get
                                                            weird with you. </p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/horror.webp"
                                                            alt="Horror Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="pills-portfolio11" role="tabpanel"
                                        aria-labelledby="pills-portfolio11-tab" tabindex="0">
                                        <div class="portfolio-tabitem-inner">
                                            <div class="row align-items-center">
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-content" data-aos="fade-right"
                                                        ...
                                                        <p>For stories that are a little more "after dark," we provide a
                                                            professional, judgment-free space to polish your steamier
                                                            side. We help you balance the heat with a great plot,
                                                            ensuring your spicy scenes are high-quality, tasteful, and
                                                            exactly what your audience is craving. No blushing here, we
                                                            promise.</p>
                                                        <div class="website-main-buttons">
                                                            <a class="popup-btn" data-bs-toggle="modal"
                                                                data-bs-target="#staticBackdrop">Let's Get Started</a>
                                                ...
                                                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <div class="portfolio-tabitem-img">
                                                        <img src="assets/images/categories/adult.webp"
                                                            alt="Horror Book Image" class="img-fluid box2">
                                                    </div>
                                                </div>
                                            </div>
        ...
        <section class="counter-satisfy-wrap">
            ...
            <div class="container">
                <div class="counter-satisfy-inner">
                    <div class="counter-satisfy-box" data-aos="zoom-out" data-aos-duration="1000">
                        <div class="counter-box-head">
                            <h4 class="heading-two"><span id="number1">19</span></h4>
                        </div>
                        <p>#1 New York <br>Times Bestsellers</p>
                    </div>
                    <div class="counter-satisfy-box" data-aos="zoom-out" data-aos-duration="1000">
                        <div class="counter-box-head">
                            <h4 class="heading-two"><span id="number2">310</span>+</h4>
                        </div>
                        <p>National <br>Bestsellers</p>
                    </div>
                    <div class="counter-satisfy-box" data-aos="zoom-out" data-aos-duration="1000">
                        <div class="counter-box-head">
                    ...
                    <div class="row align-items-center">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class="unlock-story-content" data-aos="fade-right" data-aos-duration="1500">
                                ...
                                <p>Publishing a book can feel like trying to find your way through a maze in the dark,
                                    but
                                    hey, hey, we’re here to turn the lights on. Our team lives and breathes books, and
                                    we’re
                                    obsessed with making sure yours doesn't just sit on a shelf, but actually gets read.
                                </p>
                                <ul>
                                ...
                                <div class="website-main-buttons">
                                    <a class="popup-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Let's
                                        Get
                                        Started</a>
                ...
                <div class="service-offer-inner">
                    <div class="service-offer-slider">
                        <div class="service-offer-box" data-aos="flip-up" data-aos-easing="ease-out-cubic"
                            ...
                            <p>Your project might be a sprawling space odyssey or a secret family recipe book, either
                                way,
                                our team has the range to handle it. No matter the genre, we know exactly how to bring
                                your
                        ...
                        <div class="service-offer-box" data-aos="flip-up" data-aos-easing="ease-out-cubic"
                            ...
                            <p>We aren't here to change your story; we’re here to help you tell it. We match your
                                personal
                        ...
                        <div class="service-offer-box" data-aos="flip-up" data-aos-easing="ease-out-cubic"
                            ...
                            <p>People do judge books by their covers, so we make sure yours is a showstopper. Our
                                designs
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-xxl-10 col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                        <div class="cta-main-content" data-aos="zoom-in-down" data-aos-duration="1500">
                            ...
                            <p>At Godspeed Publishing, we know your book is one-of-a-kind. Our mission is to make sure
                                the
                                final product reflects your exact vision while meeting the highest professional
                                standards.
                                Contact us now!</p>
                            <div class="website-main-buttons">
                                <button class="chat-btn" onclick="<?php echo $locChatClick; ?>">Live Chat!</button>
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="content">
                            ...
                            <p>Godspeed Publishing is your partner from the first page to the final sale. Once you team
                                up with us, you can breathe easy because we handle the heavy lifting while you keep the
                                creative spark alive.</p>
                            <span>What to expect?</span>
                            <ul>
                                <li><strong>A 30-Minute Brainstorm:</strong> We’ll sit down one-on-one to validate your
                                    idea and answer every "what if" on your mind.</li>
                                <li><strong>Your Personal Roadmap:</strong> You’ll walk away with a clear, step-by-step
                                    plan to take your project from a brief to a finished book.</li>
                                <li><strong>A Custom Game Plan:</strong>We’ll provide a personalized solution and a
                                    transparent quote tailored specifically to your story’s needs.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="calendly-inline-widget"
                            data-url="https://calendly.com/goodspeedpublishing-info/goodspeed-publishing">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="customer-feedback-content">
                            ...
                            <div class="customer-feedback-slider">
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt1.webp"
                                                alt="Thumb Girl" class="img-fluid">
                                        </div>
                                    ...
                                    <div class="feedback-slider-para">
                                        <p>"Experience was great. Nikki, my Project Manager, was very professional. I
                                            look
                                ...
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt2.webp"
                                                alt="Thumb Boy" class="img-fluid">
                                        </div>
                                        <div class="feedback-slider-text">
                                    ...
                                    <div class="feedback-slider-para">
                                        <p>"Goodspeed Publishing boosted Lead Magnet Formula with expert marketing,
                                            social
                                ...
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt3.webp"
                                                alt="Thumb Boy" class="img-fluid">
                                        </div>
                                        <div class="feedback-slider-text">
                                    ...
                                    <div class="feedback-slider-para">
                                        <p>"The majority of my experience working with Goodspeed Publishing to publish
                                            my
                                            book was good. The entire team was helpful and effective, although I thought
                                            the
                                            timeframe should have been communicated more clearly. Ultimately, the book
                                            was
                                ...
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt4.webp"
                                                alt="Thumb Boy" class="img-fluid">
                                        </div>
                                        <div class="feedback-slider-text">
                                ...
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt5.webp"
                                                alt="Thumb Boy" class="img-fluid">
                                        </div>
                                        <div class="feedback-slider-text">
                                    ...
                                    <div class="feedback-slider-para">
                                        <p>"The entire experience was wonderful! My communications with Tammie were
                                            great
                                            and very helpful. A few years back, my wife published a book with Goodspeed
                                            Publishing. That was also a wonderful experience. Morris Publishing is
                                            highly
                                            recommended!"</p>
                                    </div>
                                </div>
                                <div class="feedback-slider-box" data-aos="fade-right" data-aos-duration="1000">
                                    <div class="feedback-box-head">
                                        <div class="feedback-slider-thumb">
                                            <img loading="lazy" src="assets/images/testimonials/tt6.webp"
                                                alt="Thumb Boy" class="img-fluid">
                                        </div>
                                        <div class="feedback-slider-text">
                                    ...
                                    <div class="feedback-slider-para">
                                        <p>"Goodspeed Publishing made the entire publishing and printing process for our
                                            book a dream! It was seamless. The final product is not only great, but also
                                            the
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="contact-main-image" data-aos="fade-right" data-aos-duration="1500">
                            <img loading="lazy" src="assets/images/book-publishing/talk-to-us.webp"
                                alt="Contact Main Book" class="img-fluid box2">
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item" data-aos="fade-right" data-aos-duration="1500">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            Most projects take between 4 to 8 weeks. Your own speed matters here,
                                            because
                                ...
                                <div class="accordion-item" data-aos="fade-right" data-aos-duration="1500">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            The stores where your book is sold handle everything. Amazon prints and
                                            ships
            ...
            <div class="container">
                <div class="footer-logo-area">
                    ...
                    <ul class="footer-social-links">
                        <li><a href="https://www.facebook.com/goodspeedpublishing/" target="_blank"><i
                                    class="fab fa-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/goodspeedpublishing/" target="_blank"><i
                                    class="fab fa-instagram"></i></a></li>
                        <li><a href="https://x.com/GoodspeedPub" target="_blank"><i
                                    class="fa-brands fa-x-twitter"></i></a></li>
                        <li><a href="https://www.linkedin.com/company/goodspeed-publishing" target="_blank"><i
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="footer-disclaimer-area">
                        <p>
                            ...
                            All content, services, and products offered through our website are solely provided by
                            Goodspeed
                    ...
                    <div class="row align-items-center">
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 p-0">
                            <div class="modal-body-img1">
                                <img src="assets/images/unlock-story-marketing.webp" alt="img" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 p-0">
                            <div class="modal-body-form">
                                ...
                                <form class="myForm"
                                    action="https://leads.infinityprojectmanager.com/brand/goodspeedpublishing/lead"
                                    method="GET">
                                    <input type="hidden" name="city" class="city">
                                    <input type="hidden" name="country" class="country">
                                    <input type="hidden" name="ip" class="ip">
                                    ...
                                    <input type="hidden" name="brand_name" value="goodspeedpublishing.com">
                                    <input type="hidden" id="lead_area" name="lead_area"
                                        value="https://goodspeedpublishing.com/">
                                    <div class="popup-form-list">
                                        ...
                                        <div class="form-group mdl-phone-inp">
                                            <input type="phone" class="countryCode" name="phone" required>
                                            <input type="hidden" class="fullPhoneNumber" name="fullPhoneNumber">
                                        </div>
                                        <div class="form-group">

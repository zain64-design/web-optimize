...
async function getOptions(program) {
    const { config, css, content, output, fontFace, keyframes, variables, rejected, rejectedCss, safelist, blocklist, skippedContentGlobs, preservePaths, } = program.opts();
...
async function run(program) {
    ...
    if (options.output) {
        ...
        for (const purgedResult of purged) {
            let outputPath;
            if (preservePaths && (purgedResult === null || purgedResult === void 0 ? void 0 : purgedResult.file)) {
